...
(deffunction domain-load-local-facts ()
	(assert
        ...
        (domain-fact (name item-at-station) (param-values storage-bun bun1))
        (domain-fact (name item-at-station) (param-values storage-bun bun2))
        (domain-fact (name item-at-station) (param-values storage-bun bun3))
        (domain-fact (name item-at-station) (param-values storage-beef beef1))
        (domain-fact (name item-at-station) (param-values storage-beef beef2))
        (domain-fact (name item-at-station) (param-values storage-beef beef3))
        (domain-fact (name item-at-station) (param-values storage-cheese cheese1))
        (domain-fact (name item-at-station) (param-values storage-cheese cheese2))
        (domain-fact (name item-at-station) (param-values storage-cheese cheese3))
        (domain-fact (name item-at-station) (param-values storage-lettuce lettuce1))
        (domain-fact (name item-at-station) (param-values storage-lettuce lettuce2))
        (domain-fact (name item-at-station) (param-values storage-lettuce lettuce3))
        (domain-fact (name item-at-station) (param-values storage-tomato tomato1))
        (domain-fact (name item-at-station) (param-values storage-tomato tomato2))
        (domain-fact (name item-at-station) (param-values storage-tomato tomato3))
        (domain-fact (name item-at-station) (param-values sink plate1))
        (domain-fact (name item-at-station) (param-values sink plate2))
        (domain-fact (name item-at-station) (param-values sink plate3))
